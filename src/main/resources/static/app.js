...
// Alias for HTML compatibility - some HTML files call confirmSellStock instead of confirmRemoveStock
const confirmSellStock = confirmRemoveStock;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listeners for sell quantity input
    ...
    if (sellQtyInput) {
        ...
        sellQtyInput.addEventListener('blur', function() {
            if (currentRemoveHolding) {
                let val = parseInt(this.value) || 1;
                if (val > currentRemoveHolding.totalQuantity) {
                    this.value = currentRemoveHolding.totalQuantity;
                    document.getElementById('quantitySlider').value = currentRemoveHolding.totalQuantity;
                } else if (val < 1) {
                    this.value = 1;
